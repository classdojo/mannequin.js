  ...
  module.exports = Model = (function(_super) {
    ...
    */
    ...
    Model.prototype.init = function() {
      var def, refClass, transformer, _i, _len, _ref, _results,
        _this = this;
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        transformer = this.transform(def.key);
        if (def.options.$multi) {
          transformer.map(function(source) {
            var col;

            col = _this._createCollection();
            col.parent = _this;
          ...
          this._set(def.key, this.get(def.key) || []);
        } else {
          transformer.cast(refClass);
        }
        _results.push(transformer.reset());
      }
      return _results;
    };
    ...
    */
    ...
    Model.prototype._createCollection = function() {
      return this.builder.createCollection(this);
    };
