    ...
    */
    ...
    Model.prototype._toJSON = function(data) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        definition = _ref[_i];
        v = data.__isBindable ? data.get(definition.key) : dref.get(this, definition.key);
        if (v === void 0) {
          continue;
        }
        dref.set(newData, definition.key, v);
      }
      newData._id = this.get("_id");
      _id = data.__isBindable ? data.get(definition.key) : dref.get(this, definition.key);
      if (_id) {
        newData._id = _id;
      }
      return newData;
